# Wringer 打包驗證 e70_p3a_w(vs exports/e70_p3a_w)

- 模組 252,本體權重 3,633,315,840;容器 `data/wringer_e70_p3a_w.safetensors` 1.116 GiB = 2.6385 b/w(safetensors 頭與對齊含在內)
- 帳面:碼 2.5195 + α 0.1188 = **2.6383 b/w**(ledger total_fixed 對照見 quant_e70_p3a_w.json)
- R1 碼往返不一致:0(須 0)
